...
//   atecc.write(0x00, (16 / 4), data1, 4);
  ...
  {
    Serial.println();
    Serial.println("Locking of the Data Zone beginning.");

    Serial.println("Locking of Slot 1 in the Data Zone beginning.");
    Serial.print("Lock Slot 0: \t");
    if (atecc.lockDataSlotN(1) == true) Serial.println("Success!");
    else Serial.println("Failure.");

    
    Serial.println("Locking of Configuration done.");
    Serial.println();
  }
  else
  {
...
void printInfo()
{
  ...
  {
    if(atecc.generatePublicKey(14,true) == false)
    {
